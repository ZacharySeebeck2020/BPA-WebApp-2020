    ...
    <div class="content_card mb-5">
        <div class="content-card bg-gray-200 px-10 pt-10 pb-1 rounded-lg my-5">
            ...
            <div class="mx-3">
                ...
                <div class="my-5">
                    <label class="input_label" for="slug">Slug <span class="text-gray-600">(
                            {{ config('app.url')}}/{slug} )</span></label>
                    <input class="input_field" name="slug" type="text" required value="{{ old('slug') }}"
                        placeholder="URL Slug (ex. t-shirt)">
                </div>

                <div class="my-5">
                    <label class="input_label" for="price">Price</label>
                    <input class="input_field" name="price" type="number" required value="{{ old('price') }}"
                        placeholder="$12.53">
                </div>

                <div class="my-5">
                    <div class="relative">
                        <label class="input_label" for="category">Product Category</label>
                        <select name="category" class="input_field appearance-none">
                ...
                <div class="my-5">
                    <div class="flex items-center justify-left w-full">
                        <label for="featured" class="flex items-center cursor-pointer">
                            ...
                            <div class="relative">
                                <input id="featured" name="feature" type="checkbox" class="hidden" />
        ...
        <div class="content-card bg-gray-200 px-10 pt-10 pb-1 rounded-lg my-5">
            ...
            <div class="mx-3">
                <div class="my-5">
                    <label class="input_label" for="description">Product Description</label>
                    <textarea class="input_field mb-5" name="description" id="product_description" required></textarea>
                </div>

                <div class="my-5">
                    <label class="input_label" for="features">Product Features</label>
                    <textarea class="input_field mb-5" name="featuresß" id="product_features" required></textarea>
                </div>
        </div>
    </div>
</form>
...
@section('scripts')
<script src="https://cdn.tiny.cloud/1/f7w6hiyzv7ysezi70n72tdd77vwr53z9lrq1yr2l1dqme6cv/tinymce/5/tinymce.min.js"></script>
