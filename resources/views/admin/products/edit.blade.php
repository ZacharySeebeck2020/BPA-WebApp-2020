...
<form action="{{ route('admin.products.update', $product->id) }}" method="POST" id="product_form" enctype="multipart/form-data">
    @csrf
        ...
        <div class="content-card bg-gray-200 px-10 pt-10 pb-1 rounded-lg my-5">
            ...
            <div class="mx-3">
                <div class="my-2">
                    ...
                    <input class="input_field" id="name" name="name" type="text" required value="{{ old('name') ?? $product->name }}"
                ...
                <div class="my-5">
                    ...
                    <input class="input_field" id="slug" name="slug" type="text" required value="{{ old('slug') ?? $product->slug }}"
                        placeholder="URL Slug (ex. t-shirt)" required>
                </div>

                <div class="my-5">
                    <label class="input_label" for="price">Price <span class="required">*</span></label>
                    <input class="input_field" id="price" name="price" type="text" required value="{{ old('price') ?? $product->price }}"
                        placeholder="$12.53">
                </div>
        ...
        <div class="content-card bg-gray-200 px-10 pt-10 pb-1 rounded-lg my-5">
            ...
            <div class="mx-3">
                ...
                <div class="my-5">
                    ...
                    <input class="input_field mb-5" id="short_description" name="short_description" value="{{ old('short_description') ?? $product->short_description }}">
                </div>
